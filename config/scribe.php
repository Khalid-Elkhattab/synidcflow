...
return [
    ...
    'title' => 'SyndicFlow — Documentation de l\'API',

    // A short description of your API. Will be included in the docs webpage, Postman collection and OpenAPI spec.
    'description' => 'API REST de la plateforme de gestion de syndic (résidences, immeubles, appartements, charges, reçus, réclamations et analyse IA).',
    ...
    'base_url' => config('app.url'),    // Routes to include in the docs
    'routes' => [
        [
            'match' => [
    ...
    'auth' => [
        ...
        // You can then use #[AllowAnonymous] or #[Authenticated] on individual endpoints to change their status from the default.
        'default' => false,
        ...
        'placeholder' => '{VOTRE_TOKEN}',

        // Any extra authentication-related info for your users. Markdown and HTML are supported.
        'extra_info' => 'Récupérez votre jeton via <code>POST /api/v1/register</code> ou <code>POST /api/v1/login</code>, puis transmettez-le dans l\'en-tête <code>Authorization: Bearer &lt;jeton&gt;</code>.',
    ],
