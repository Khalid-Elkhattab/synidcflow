    ...
    */
    ...
    'providers' => [
        ...
        'groq' => [
            ...
            'models' => [
                'text' => [
                    'default' => env('GROQ_MODEL', 'meta-llama/llama-4-scout-17b-16e-instruct'),
                    'cheapest' => env('GROQ_MODEL', 'meta-llama/llama-4-scout-17b-16e-instruct'),
                    'smartest' => env('GROQ_MODEL', 'meta-llama/llama-4-scout-17b-16e-instruct'),
                ],
            ],
        ],
